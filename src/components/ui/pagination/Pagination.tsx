            ...
            allPages.map((page, index) => (
              ...
              <li key={page} className="page-item">
                <Link
                  className={
                    clsx(
                      "page-link relative block py-1.5 px-3 border-0 outline-none transition-all duration-300 rounded hover:bg-orange-300 text-gray-800 hover:text-gray-800 focus:shadow-none",
                      {
                        'bg-naranja shadow-sm text-white hover:text-white  ': page === currentPage
                      }
                    )
                  }
