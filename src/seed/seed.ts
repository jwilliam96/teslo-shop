...
export const initialData: SeedData = {
  ...
  products: [
    ...
    {
      description: "Designed for style and comfort, the ultrashort Women's T Logo Short Sleeve Scoop Neck Tee features a tonal 3D silicone-printed T logo on the left chest. Made of 50% Peruvian cotton and 50% Peruvian viscose.",
      images: [
