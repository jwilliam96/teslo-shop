...
export const AddressForm = ({ countries, userStoredAddress = {} }: Props) => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 gap-2 sm:gap-5 sm:grid-cols-2">
      ...
      <div className="flex flex-col mb-2">
        <span>Dirección</span>
        <input type="text" className="p-2 border rounded-md bg-white border-gray-300" {...register('address', { required: true })} />
      </div>
      ...
      <div className="flex flex-col mb-2">
        <span>País</span>
        <select className="p-2 border rounded-md bg-white border-gray-300" {...register('country', { required: true })}>
      ...
      <div className="flex flex-col mb-2 sm:mt-1">
        ...
        <div className="inline-flex items-center mb-10 ">
          ...
          >
            <input
              type="checkbox"
              className="border-gray-500 before:content[''] peer relative h-5 w-5 cursor-pointer appearance-none rounded-md border border-blue-gray-200 transition-all before:absolute before:top-2/4 before:left-2/4 before:block before:h-12 before:w-12 before:-translate-y-2/4 before:-translate-x-2/4 before:rounded-full before:bg-blue-gray-500 before:opacity-0 before:transition-opacity checked:naranja checked:bg-naranja checked:before:bg-naranja hover:before:opacity-10"
              id="checkbox"
